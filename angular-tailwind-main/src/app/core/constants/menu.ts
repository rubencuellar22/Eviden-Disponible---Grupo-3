  ...
  public static pages: MenuItem[] = [
    {
      ...
      items: [
        ...
        // },  
        {
          ...
          route: '/idioma',
          children: [
            { label: 'A1 Beginner', route: '/dashboard/nfts' },
            { label: 'A2 Elementary', route: '/dashboard/nfts' },
            { label: 'B1-B2 Intermediate', route: '/dashboard/nfts' },
            { label: 'C1 Advanced', route: '/dashboard/nfts' },
            { label: 'C2 Mastery', route: '/dashboard/nfts' },
          ],
        },
        {
          ...
          children: [
            { label: '1', route: '/dashboard/nfts' },
            { label: '2', route: '/dashboard/nfts' },
            { label: '3', route: '/dashboard/nfts' },
            { label: '4', route: '/dashboard/nfts' },
            { label: '5', route: '/dashboard/nfts' },
          ],
        },  
        {
        ...
        },  
        {
          ...
          route: '/codigo-de-la-computadora-portatil',
          children: [
            { label: '1', route: '/dashboard/nfts' },
            { label: '2', route: '/dashboard/nfts' },
            { label: '3', route: '/dashboard/nfts' },
